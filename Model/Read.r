...
OneRun <- function(FishingMortality,HarvestRate,WeightCorr,WeightCV,RecrCorr,AssessmentCV,AssessmentCorr,AssessmentBias,Btrigger,MaxChange,Meanwtyears,LastYearsTacRatio,HCRreflength,inputprogfile='',inputfile="icehad.dat.prog",path=".",progoutfile="hadprognosis.dat",model="muppet"){
